...
execute @e[type=area_effect_cloud,name=Main,tag=EndGame] ~ ~ ~ scoreboard players tag @a[tag=Playing] add LeaveGame
function overhead:player/leave_game if @e[type=area_effect_cloud,name=Main,tag=EndGame]
